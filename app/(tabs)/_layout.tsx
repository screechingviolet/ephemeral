import { useLocalSearchParams } from "expo-router"; // <--- Added this
...
export default function HomeScreen() {
    ...
    // New: Screen Opacity for the "Soft Reset"
    const screenOpacity = useRef(new Animated.Value(1)).current;

    // --- HANDLE SOFT RESET (Tab Press) ---
    useEffect(() => {
        if (!refresh) return;
    ...
    if (phase === "landing") {
        return (
            <AnimatedImageBackground
                ...
                style={[styles.screen, { opacity: screenOpacity }]} // Applied opacity here
                resizeMode="cover"
            >
                <ThemedView
                    style={styles.screen}
